...
public class FavoriteSetsAdapter extends RecyclerView.Adapter<FavoriteSetsAdapter.FavoritesViewHolder> {
    ...
    class FavoritesViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        ImageView currentSetView;
        @Bind(R.id.savedSet)
        ImageView savedSetView;
        ...
        public FavoritesViewHolder(View view) {
            ...
            currentSetView.setOnClickListener(this);
            savedSetView.setOnClickListener(this);
        }
        ...
        public void onClick(View v) {
            ...
            switch (id) {
                case R.id.favItem:
                    ...
                    break;
                case R.id.currentSet:
                    new DialogEditFav(mContext, FavoriteSetsAdapter.this, mItems.get(pos), true);
                    break;
                case R.id.savedSet:
                    new DialogEditFav(mContext, FavoriteSetsAdapter.this, mItems.get(pos), false);
                    break;
            }
        }
    }
